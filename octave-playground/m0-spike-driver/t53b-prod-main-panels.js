...
(async () => {
  ...
  console.log('prod: separator count:', await separators.count());
  ...
  console.log('prod: sidebar widened via drag:', sidebarAfter.width > sidebarBefore.width + 100);
  ...
  console.log('prod: File Browser collapsed:', collapsedBox.height < 50);
  ...
  console.log('prod: File Browser expanded back:', expandedBox.height > 100);
  ...
  console.log('prod: Run Tests still works after panel ops:', /Score: \d+\/30 points/.test(bodyText));
