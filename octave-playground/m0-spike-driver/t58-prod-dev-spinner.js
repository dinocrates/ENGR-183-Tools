...
(async () => {
  ...
  console.log('dev: spinner visible during delay:', spinnerVisible);
  const noChartYet = (await page.locator('.js-plotly-plot').count()) === 0;
  console.log('dev: no chart rendered yet:', noChartYet);
  ...
  console.log('dev: spinner gone once rendered:', !spinnerGone);
